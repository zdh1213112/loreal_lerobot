...
def _cleanup_pico4_startup(teleop: Teleoperator) -> None:
    ...
    if xrt is not None:
        for close_name in ("close", "uninitialize", "uninit"):
            close_fn = getattr(xrt, close_name, None)
