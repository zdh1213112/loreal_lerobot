        ...
        if norm_mode == NormalizationMode.QUANTILES:
            ...
            if q01 is None or q99 is None:
                raise ValueError(
                    ...
                    "Please update your dataset with quantile statistics by "
                    "running:\n"
                    "  python src/lerobot/datasets/v30/augment_dataset_quantile_stats.py "
                    f"--repo-id=<your_dataset_repo_id>"
                    "Replace <your_dataset_repo_id> with your dataset's "
                    "repo-id (e.g., 'lerobot/pusht')."
                )
